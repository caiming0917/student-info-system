        ...
        FastAutoGenerator.create(configBuilder)
                .globalConfig(builder -> {
                    builder.author("cai juan") // 设置作者
                            ...
                            .outputDir("D://develop/code/user-info-system/user-service/src/test/java/")// 指定输出目录
                            // .disableOpenDir()
                ...
                .packageConfig(builder -> {
                    builder.parent("com.caijuan") // 设置父包名
                            ...
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "D://develop/code/user-info-system/user-service/src/main/resources/mapper")); // 设置mapperXml生成路径
                })
                .strategyConfig(builder -> {
                    builder.enableSchema()    // 启用 schema
                            .addInclude("stu_user") // 设置需要生成的表名
